...
class HexLayout:
    ...
    def update_metrics(self, fm: QFontMetrics):
        ...
        # Include glyph ink and spacing, even when a platform font falls back.
        self.char_w = max(max(fm.horizontalAdvance(chr(c)), fm.boundingRect(chr(c)).width())
                          for c in range(32, 127)) + 2
